...
# FIX 2: Added use_safetensors=False
...
class DeBERTaABSA:
    ...
    def __init__(self):
        ...
        # FIX 3: Added use_safetensors=False
...
output_path = "../indexing/dataset/football_index_scored_test.json"

print("Loading dataset...")
with open(input_path, 'r', encoding='utf-8') as f:
    docs = json.load(f)

# TEST SUBSET: First 10 threads
docs = docs[:100]
print(f"Testing on {len(docs)} threads...")
